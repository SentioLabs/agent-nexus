...
This command stores in mneme's memory system — searchable, scoreable, and visible in the web UI. This complements agent-specific local memory features. Use runtime-local memory for session context and mneme for the shared knowledge base.

For OpenCode-oriented transparent memory workflows, use a conservative capture policy:
