...
description: >
  Use when the user asks to build web components, pages, applications, or other frontend
  interfaces that need distinctive, production-grade UI/UX implementation and should avoid
...
This OpenCode port is adapted from Anthropic's official `frontend-design` Claude Code skill.
It guides creation of distinctive, production-grade frontend interfaces that avoid generic
"AI slop" aesthetics. Implement real working code with exceptional attention to aesthetic
...
elaborate code with extensive animations and effects. Minimalist or refined designs need
restraint, precision, and careful attention to spacing, typography, and subtle details. Elegance
comes from executing the vision well.

Remember: OpenCode is capable of extraordinary creative work. Don't hold back, show what can
